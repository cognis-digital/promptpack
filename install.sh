#!/usr/bin/env sh
# Universal installer for promptpack. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/promptpack.git"
echo "Installing promptpack ..."
