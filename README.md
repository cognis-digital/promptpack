...
[![PyPI](https://img.shields.io/pypi/v/cognis-promptpack.svg)](https://pypi.org/project/cognis-promptpack/)
[![CI](https://github.com/cognis-digital/promptpack/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/promptpack/actions)
...
PROMPTPACK exists for one job — versioned prompt / template registry with a/b and rollbacks — and does it without a SaaS bill or heavyweight setup.
...
```bash
promptpack --version
promptpack scan .                      # scan the current project
promptpack scan . --format json
promptpack scan . --fail-on high       # non-zero exit for CI gates
promptpack mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **promptlayer**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`promptpack` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
